...
#include "XGiFlyTekTTSReqType.generated.h"
/**
...
USTRUCT()
struct XGIFLYTEKTTS_API FXGiFlyTekTTSReqCommonInfo
{
	GENERATED_BODY()
...
struct XGIFLYTEKTTS_API FXGiFlyTekTTSReqBusinessInfo
{
	GENERATED_BODY()
...
USTRUCT()
struct XGIFLYTEKTTS_API FXGiFlyTekTTSReqDataInfo
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct XGIFLYTEKTTS_API FXGiFlyTekTTSReqInfo
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "XG iFylTek TTS")
	FXGiFlyTekTTSReqBusinessInfo business;

protected:

	UPROPERTY()
	FXGiFlyTekTTSReqCommonInfo common;

	UPROPERTY()
	FXGiFlyTekTTSReqDataInfo data;
