...
FString FXGiFlyTekRealTimeSTTReqInfo::GenerateRequireParams()
{
	FString RetStr=TEXT("");

	FString AppID = UXGiFlyTekCoreSettings::GetXGiFlyTekCoreSettings()->AppID;
	FString APIKey = UXGiFlyTekCoreSettings::GetXGiFlyTekCoreSettings()->APIKeySTT;
...
FString FXGiFlyTekRealTimeSTTReqInfo::GenerateSigna(const FString& InAppid, const FString& InTS, const FString& InAPIKey)
{
